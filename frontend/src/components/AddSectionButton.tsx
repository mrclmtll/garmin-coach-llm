...
import { blankStep, blankSwimBlock, STEP_ROLE_LABELS, stepRoleLabel } from "../lib/steps";
...
const ROLE_KEYS = Object.keys(STEP_ROLE_LABELS) as StepRole[];
